        ...
        <div class="col-12">
          <card>
            ...
            <template slot="header">
              <h4 class="card-title text-primary">Contract list</h4>
            ...
            <!-- Contract List Table -->
            <b-table v-if="tableOne.data.length > 0" id="tableOne" responsive :no-provider-sorting=true ref="tableOne" bordered hover :items="tableOne.data" :fields="tableOne.fields">
            ...
            <!--
            <h3 v-if="tableOne.data.length<=0"> No contracts found for Owner <b>{{selected}}</b> </h3><br>
            -->
            <h3 v-if="noContractsFoundMessage"> No contracts found for Owner <b>{{selected}}</b> </h3><br>
            ...
            <card v-if="tableOne.data.length > 0 || page > 0">
              <div class="row justify-content-center d-flex align-items-center" > 
                ...
                <div class="col-md-6 d-flex align-items-center">    
                  <md-button class="md-primary" :disabled="rowPerPage<2" v-on:click="decreaseContractPerPage()"> - </md-button>
                  <label> Show <b> {{ rowPerPage }} </b> Contracts per page </label>
                  <md-button class="md-primary" :disabled="rowPerPage>19" v-on:click="increaseContractPerPage()"> + </md-button>
                </div>
                <div class="col-md-3">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      increaseContractPerPage: function () {        
        this.rowPerPage ++;
      },

      decreaseContractPerPage: function () {
        this.rowPerPage --;
      },
      ...
      getContracts: function () {
        ...
        http.get('/' + this.selected + '/contracts/?limit=' + this.rowPerPage + '&offset=' + this.page)
        .then(response => {
          if(response.data.length==0) {
            this.noContractsFoundMessage = true
          } else {
            this.noContractsFoundMessage = false
          }
      ...
      showDetails(item, index) {
        var app = this;
        app.$router.push("/contractDetails/" + item.id);
      },
