        ...
        <div class="col-12">          
          <card>
            <template slot="header">
              <h4 class="card-title text-primary">Smart Contract <b>Tesoreria</b> </h4>  
          ...
          <card>            
            <md-tabs class="md-transparent" md-alignment="fixed">
              ...
              <md-tab id="token" md-label="Token">
                <card>
                  <br><h5>Name: {{name}}</h5>
                  <br><h5>Symbol: {{symbol}}</h5>
                  <br><h5>Total supply: {{total_supply}}</h5>
                  <br>                  
                </card>
              </md-tab>
              ...
              <md-tab id="transaction" md-label="Transaction">
                <card>
                  <br>
                  <br>
                  <br>
              ...
              <md-tab id="cashinout" md-label="Cashin / cashout">
                <card>
                  <br>
                  <br>
                  <br>
  ...
  export default {
    ...
    methods: {
      ...
      getSmartContractById: function () {
        ...
        http.get('/' + OWNER + '/smartcontracts/22')
        .then(response => {                               
      ...
      getTokenInfo: function() {
        ...
        // define tx array
        let txArray = {
          "blockchainIdentifier": 1,
          "contractIdentifier": "0x3ba7c2578B59e0e1CcfeE9A20D92F043C0e0b3e6",
          "functionPayload": {
            "changeBlockchainState": "false",
            "functionName": "name",
            "input": [],
            "output": ["string"],
        ...
        // 1° call, get name, poi symbol e total supply
        var http = axios.create({
          baseURL: process.env.VUE_APP_PROXY_ENDPOINT,          
        });
        ...
        // 3° call, get total supply
        var http = axios.create({
          baseURL: process.env.VUE_APP_PROXY_ENDPOINT,          
        });
        http.post('/' + OWNER + '/call/', txArray)
        .then(response => {                      
          this.total_supply = response.data
        }).catch(e => { console.log(e) });
      ...
      deleteSmartContract: function() {
        if(confirm('Are you sure?')) {
          return new Promise((resolve, reject) => {             
            ...
            http.delete('/' + OWNER + '/smartcontracts/22')
            .then(response => {           
              resolve(response.data);            
            })
            .catch(e => {
