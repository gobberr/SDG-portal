...
paramsHeader = {
  ...
  //"endpoint": "http://localhost:8000/smartweb", 
  "owner": "Hera"    
}
/**
                    ...
                    xmlHttpRequest.onreadystatechange = function () {  
                        if (this.readyState === 4) { 
                            if (this.status == 200) {                              
                                ...
                                elmnts[i].innerHTML = "Template not found.";
                            }
                            setTodayDate();
                        }
                    };  
                    ...
                    xmlHttpRequest.onreadystatechange = function () {  
                        if (this.readyState === 4) { 
                            if (this.status == 200) {  
                                ...
                                elmnts[i].innerHTML = "Contract not found.";
                            }
                        }
                    };  
                }(i);  
      ...
      */
      ...
      xhr.onload = function() {
          if (xhr.status === 200) {
              ...
              styleResultMessage(data.getElementsByTagName('output')[data.getElementsByTagName("output").length - 1],"Contract saved",false)
